...
project = 'PCVS'
copyright = "2020-{}, Commissariat a l'Energie Atomique et aux Energies Alternatives".format(datetime.now().date().year)  # pylint: disable=redefined-builtin
author = 'Julien Adam'
...
version = version("pcvs")
# The full version, including alpha/beta/rc tags.
release = version("pcvs")
